...
public class EntrepreneurPortalController {
    ...
    public EntrepreneurPortalController(
            EntrepreneurPortalService portalService) {

        this.portalService = portalService;
    }

    /*
     * Henter den loggede fagpersons profil.
     */
    @GetMapping("/profile")
    public EntrepreneurPortalResponse getMyProfile(
            Authentication authentication) {

        return portalService.getMyProfile(
                authentication.getName()
        );
    }

    /*
     * Opdaterer profiloplysninger.
     */
    @PutMapping("/profile")
    public EntrepreneurPortalResponse updateMyProfile(
        ...
        return portalService.updateMyProfile(
                authentication.getName(),
                request
        );
    }
    ...
    /*
     * Ændrer om fagpersonen tager imod opgaver.
     */
    ...
    public EntrepreneurPortalResponse updateAvailability(
        ...
        return portalService.updateAvailability(
                authentication.getName(),
                request
        );
    }
