...
public class UpdateEntrepreneurProfileRequest {
    ...
    @Size(
            max = 120,
            message = "Virksomhedsnavnet må højst være 120 tegn"
    )
    private String companyName;

    @Size(
            max = 2000,
            message = "Beskrivelsen må højst være 2000 tegn"
    )
    ...
    @Size(
            max = 30,
            message = "Telefonnummeret må højst være 30 tegn"
    )
    ...
    @Size(
            max = 150,
            message = "Emailen må højst være 150 tegn"
    )
    ...
    @Size(
            max = 120,
            message = "Området må højst være 120 tegn"
    )
