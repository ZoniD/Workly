...
public interface EntrepreneurRepository
        extends JpaRepository<Entrepreneur, Long> {

    List<Entrepreneur> findByStatusAndActiveTrueOrderByRatingDesc(
            EntrepreneurStatus status
    );

    List<Entrepreneur> findByStatusAndActiveTrueAndCategory_IdOrderByRatingDesc(
            EntrepreneurStatus status,
            Long categoryId
    );
    ...
    List<Entrepreneur> findByStatusOrderByCreatedAtDesc(
            EntrepreneurStatus status
    );
